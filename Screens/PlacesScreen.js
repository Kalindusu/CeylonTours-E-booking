  ...
  const data = [
    {
      ...
      shortDescription: "Ancient City in Sri lanka",
      properties: [
        {
          id: "10",
          name: "FabHotel Zeke",
    ...
    },
    {
      ...
      shortDescription: "Beautiful city in Sri Lanka",
      properties: [
        {
          id: "20",
    ...
    <View>
      ...
      >
        <Pressable
          ...
          style={{ flexDirection: "row", alignItems: "center", fontSize: 22 }}
        >
      ...
      >
        ...
        <MaterialIcons name="circle" size={18} color="green" />
      ) : (
        <Entypo name="circle" size={18} color="black" />
      )}
                  <Text
                    style={{ marginLeft: 6, fontSize: 16, fontWeight: "500" }}
                  >
                    {item.filter}
                  </Text>
                </Pressable>
